...
const STYLE = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .form-label { font-family: 'Space Mono', monospace; font-size: 9px; letter-spacing: 0.3em; text-transform: uppercase; margin-bottom: 18px; display: block; }
  .form-label.green { color: var(--signal); }
  .form-label.red { color: var(--blood); }
  .form-label.ice { color: var(--ice); }
  .field-label { font-family: 'Space Mono', monospace; font-size: 9px; letter-spacing: 0.25em; text-transform: uppercase; color: var(--signal); margin-bottom: 8px; display: block; }
  ...
  .err-box { padding: 14px 18px; background: var(--blood-dim); border: 1px solid rgba(212,34,0,0.3); font-family: 'Space Mono', monospace; font-size: 11px; color: var(--blood); margin-top: 18px; word-break: break-all; }
  ...
  .search-tips { margin-top: 24px; background: var(--signal-dim); border: 1px solid rgba(0,230,122,0.12); padding: 18px; }
  .search-tips-title { font-family: 'Space Mono', monospace; font-size: 9px; letter-spacing: 0.3em; text-transform: uppercase; color: var(--signal); margin-bottom: 12px; }
  .tip-row { display: flex; gap: 10px; font-size: 13px; color: rgba(238,234,224,0.7); padding: 4px 0; line-height: 1.6; }
  .tip-n { font-family: 'Space Mono', monospace; font-size: 10px; color: var(--signal); flex-shrink: 0; margin-top: 2px; }
  ...
  .sev-pill { font-family: 'Space Mono', monospace; font-size: 8px; padding: 2px 6px; flex-shrink: 0; margin-top: 2px; }
  ...
  .action-tips { background: var(--signal-dim); border: 1px solid rgba(0,230,122,0.15); padding: 16px; margin-top: 18px; }
  .action-tips-title { font-family: 'Space Mono', monospace; font-size: 9px; letter-spacing: 0.3em; text-transform: uppercase; color: var(--signal); margin-bottom: 10px; }
  ...
  .save-bar-title { font-family: 'Space Mono', monospace; font-size: 9px; letter-spacing: 0.3em; text-transform: uppercase; color: var(--ice); margin-bottom: 14px; width: 100%; }
  ...
  .save-success { font-family: 'Space Mono', monospace; font-size: 11px; color: var(--signal); padding: 10px 0; width: 100%; }
  ...
  .stat-lbl { font-family: 'Space Mono', monospace; font-size: 8px; letter-spacing: 0.12em; text-transform: uppercase; color: var(--ghost); margin-top: 3px; }
  ...
  .app-chip { font-family: 'Space Mono', monospace; font-size: 8px; letter-spacing: 0.1em; text-transform: uppercase; padding: 2px 7px; border: 1px solid var(--border); color: var(--muted); background: rgba(255,255,255,0.03); }
  .gs-chip { font-family: 'Space Mono', monospace; font-size: 8px; letter-spacing: 0.08em; padding: 2px 7px; }
  ...
  .footer { margin-top: 80px; padding-top: 20px; border-top: 1px solid var(--border); font-family: 'Space Mono', monospace; font-size: 9px; letter-spacing: 0.12em; color: rgba(255,255,255,0.12); display: flex; justify-content: space-between; flex-wrap: wrap; gap: 8px; }
  ...
  .followup-label { font-family: 'Space Mono', monospace; font-size: 8px; letter-spacing: 0.1em; text-transform: uppercase; color: var(--ghost); }
  ...
  .followup-due { font-family: 'Space Mono', monospace; font-size: 9px; color: var(--bile); }
  .followup-overdue { color: var(--blood); }

  /* EXPORT */
  .export-btn { background: none; border: 1px solid var(--signal); color: var(--signal); font-family: 'Space Mono', monospace; font-size: 9px; letter-spacing: 0.12em; text-transform: uppercase; padding: 6px 12px; cursor: pointer; transition: background 0.15s; }
  .export-btn:hover { background: var(--signal-dim); }
  ...
  .report-eyebrow { font-family: 'Space Mono', monospace; font-size: 9px; letter-spacing: 0.4em; text-transform: uppercase; color: rgba(238,234,224,0.55); margin-bottom: 6px; }
  .report-title { font-family: 'Bebas Neue', sans-serif; font-size: 40px; line-height: 0.9; letter-spacing: 0.02em; color: var(--paper); }
  .report-date { font-family: 'Space Mono', monospace; font-size: 9px; color: rgba(238,234,224,0.45); margin-top: 8px; }
  ...
  .report-stat-lbl { font-family: 'Space Mono', monospace; font-size: 8px; letter-spacing: 0.12em; text-transform: uppercase; color: var(--ghost); margin-top: 3px; }
  ...
  .copy-btn { font-family: 'Space Mono', monospace; font-size: 9px; letter-spacing: 0.1em; text-transform: uppercase; padding: 7px 14px; border: 1px solid var(--signal); color: var(--signal); background: none; cursor: pointer; transition: background 0.15s; }
  .copy-btn:hover { background: var(--signal-dim); }
...
const STATUSES = ["Saved","Applied","Interviewing","Ghosted","Rejected","Offer"];

const STATUS_EMOJI = {
  Saved: "📌", Applied: "📤", Interviewing: "🎯", Ghosted: "👻", Rejected: "✗", Offer: "🏆"
};
  ...
  return (
    <div className={cardCls}>
      ...
      {r.flags&&r.flags.length>0&&(
        <div>
          <div style={{fontFamily:"'Space Mono',monospace",fontSize:9,letterSpacing:"0.3em",color:"var(--ghost)",textTransform:"uppercase",marginBottom:10}}>Signals Detected</div>
      ...
      <div style={{marginTop:16,padding:"10px 14px",background:"rgba(255,255,255,0.03)",borderLeft:"2px solid rgba(255,255,255,0.08)"}}>
        <p style={{fontFamily:"'Space Mono',monospace",fontSize:9,color:"var(--ghost)",lineHeight:1.7,letterSpacing:"0.04em"}}>
    ...
    <div className="panel">
      <div className="form-box green-top">
        ...
        <div className="search-grid">
          ...
          <div>
            <label className="field-label" style={{color:subfields.length>0?"var(--signal)":"var(--ghost)"}}>
    ...
    <div className="panel">
      <div className="form-box red-top">
        ...
        <div style={{background:"rgba(255,255,255,0.03)",border:"1px solid var(--border)",padding:"14px 16px",marginBottom:18}}>
          ...
          <p style={{fontSize:12,color:"var(--ghost)",lineHeight:1.7,marginTop:8,fontFamily:"'Space Mono',monospace"}}>
      ...
      {result&&(
        <div ref={resultRef}>
          ...
          <div className="save-bar">
            <div className="save-bar-title">📌 Save to Application Tracker</div>
            {!saved?(
              <>
              ...
              <div className="save-success">✓ Saved to your tracker. Switch to the Tracker tab to manage it.</div>
            )}
          </div>
        </div>
      )}
...
function TrackerTab(props) {
  ...
  var [addStatus,setAddStatus] = useState("Saved");
  ...
  function handleManualAdd() {
    ...
    addApp({
      ...
      savedAt:Date.now(), manual:true,
    });
    setAddTitle(""); setAddCompany(""); setAddNotes(""); setAddUrl(""); setAddFollowup(""); setAddStatus("Saved");
    setShowAdd(false);
  }

  function exportCSV() {
    var headers = ["Title","Company","Status","Ghost Score","Verdict","Notes","Follow-up Date","Saved Date","URL"];
  ...
  if (!loaded) {
    return <div className="panel"><div style={{textAlign:"center",padding:"60px 0",fontFamily:"'Space Mono',monospace",fontSize:11,color:"var(--ghost)"}}>Loading...</div></div>;
  }
  ...
  return (
    <div className="panel">
      ...
      {apps.length>0&&(
        <div style={{fontFamily:"'Space Mono',monospace",fontSize:10,color:"var(--ghost)",marginBottom:20,display:"flex",gap:20,flexWrap:"wrap"}}>
      ...
      {filtered.length===0&&apps.length===0&&!showAdd&&(
        <div className="empty-state">
          ...
          <div style={{marginTop:24,padding:"16px",background:"rgba(201,154,0,0.08)",border:"1px solid rgba(201,154,0,0.15)",maxWidth:380,margin:"24px auto 0"}}>
            ...
            <p style={{fontSize:12,color:"var(--muted)",lineHeight:1.7}}>Once you start tracking applications, you can generate your personal Ghost Report — your response rate, active pipeline, and average Ghost Score across all your saved listings.</p>
          </div>
        </div>
      )}
...
export default function App() {
  ...
  var activeCount = storage.apps.filter(function(a){return a.status==="Applied"||a.status==="Interviewing";}).length;
    ...
    <div>
      ...
      <div className="app">
        <header className="header">
          <div>
            <div className="logo-eyebrow">AI-powered job intelligence · <a href="/" style={{color:"var(--paper)",background:"var(--blood)",textDecoration:"none",fontFamily:"'Space Mono',monospace",fontSize:9,letterSpacing:"0.2em",padding:"3px 10px"}}>← HOME</a></div>
        ...
        <footer className="footer">
          <span>GHOSTBUST v3 · 2026</span>
          <span>POWERED BY CLAUDE AI</span>
          <span>FOR JOB SEEKERS · BY JOB SEEKERS</span>
        </footer>
      </div>
    </div>
  );
